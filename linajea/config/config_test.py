...
if __name__ == "__main__":
    ...
    predict_config = PredictTrackingConfig(
        **config_dict['predict'])  # type: ignore
    ...
    print(solve_config)
    evaluate_config = EvaluateTrackingConfig(
        **config_dict['evaluate'])  # type: ignore
    print(evaluate_config)

    # complete configs
    tracking_config = TrackingConfig(
        path="sample_config_tracking.toml", **config_dict)  # type: ignore
    print(tracking_config)

    tracking_config = TrackingConfig.from_file(
        "sample_config_tracking.toml")
    print(tracking_config)
