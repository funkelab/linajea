...
def extract_edges_blockwise(**kwargs):
    ...
    for sample in samples:
        ...
        extract_edges_blockwise_sample(sample=sample, **sample_kwargs)

def extract_edges_blockwise_sample(**kwargs):
    ...
    block_write_roi = daisy.Roi(
        (0,)*4,
        daisy.Coordinate(kwargs['extract_edges']['block_size']))

    edge_move_threshold = kwargs['extract_edges']['edge_move_threshold']
    ...
    daisy.run_blockwise(
        ...
        block_read_roi,
        block_write_roi,
        process_function=lambda b: extract_edges_in_block(b, **kwargs),
...
def extract_edges_in_block(block, **kwargs):
    logger.info(
