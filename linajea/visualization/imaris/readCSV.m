...
%code
table = readtable('tgmm.csv', "ReadVariableNames", false)

%INPUT: csv with 7 columns: [id, t, z, y, x, parent_id, track_id]
...
function trackingMatrix = readCSVData(filenameCSV)

%read xml file
table = readtable(filenameCSV, "ReadVariableNames", false);
